...
most_wanted = {"acl", "lifecycle_rule", "logging", "website", "policy", "server_side_encryption_configuration", "cors_rule", "versioning", "replication_configuration", "acceleration_status"}
suspects    = {}
